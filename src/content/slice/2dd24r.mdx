...
It was easy to get going with as it can be pulled in via a CDN:
...
For more on the underlying implementation see [Rotate the World](https://www.jasondavies.com/maps/rotate) by James Davies.
